...
public class XOmniDrive implements MoveableRobot{
    ...
    */
    ...
    public void runAdvanced(Gamepad gamepad1, Gamepad gamepad2){
        ...
        FR.setPower((-x*Math.abs(x)+y*Math.abs(y)) * movePower - GetPower(lookupTable,x2)
                + ((gamepad1.dpad_up)? dpadPower:0) +((gamepad1.dpad_down)? -dpadPower:0) +((gamepad1.dpad_left)? -dpadPower:0) +((gamepad1.dpad_right)? dpadPower:0)
        );
        BL.setPower((-x*Math.abs(x)+y*Math.abs(y)) * movePower + GetPower(lookupTable,x2)
                + ((gamepad1.dpad_up)? dpadPower:0) +((gamepad1.dpad_down)? -dpadPower:0) +((gamepad1.dpad_left)? -dpadPower:0) +((gamepad1.dpad_right)? dpadPower:0)
        );
        BR.setPower((x*Math.abs(x)+y*Math.abs(y)) * movePower - GetPower(lookupTable,x2)
                + ((gamepad1.dpad_up)? dpadPower:0) +((gamepad1.dpad_down)? -dpadPower:0) +((gamepad1.dpad_left)? dpadPower:0) +((gamepad1.dpad_right)? -dpadPower:0)
        );
    }
